...
5. If the change can be applied safely:
   ...
   - When modifying the spec, MUST set `meta.approved = false` and remove `meta.approvedAt` and `meta.approvedDigest` to automatically invalidate any previous approval.
