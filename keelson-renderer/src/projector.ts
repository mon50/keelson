...
export function projectSpec(spec: KeelsonSpec): SpecProjection {
  ...
  return {
    appName: spec.meta?.name || 'Keelson Preview',
...
function projectUiItems(spec: KeelsonSpec): UiViewProjection[] {
...
function projectFields(spec: KeelsonSpec, view: ViewDef): ProjectedField[] {
...
function collectRequirementsForView(spec: KeelsonSpec, viewName: string, view: ViewDef): string[] {
...
function projectNonUiItems(spec: KeelsonSpec): NonUiProjection[] {
...
function coreSpecSections(spec: KeelsonSpec): NonUiSection[] {
  return [
...
function requirementsSection(requirements: KeelsonSpec['requirements']): NonUiSection | undefined {
...
function createEmptyUiItem(spec: KeelsonSpec): UiViewProjection {
  return {
    id: 'view-empty',
    panelId: 'view-empty',
    label: 'UIビュー未定義',
...
function inferFirstEntityName(spec: KeelsonSpec): string | undefined {
