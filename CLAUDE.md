...
Start a rough or large idea with `/keel-discovery`; it routes the work before the flow below.
...
For a small change or bug fix, use `/keel-quick` instead of the full flow.
