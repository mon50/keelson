...
## ステップ 3: User Stories と Design
次のフェーズに進む前に、各アーティファクトを承認します。
```
/keel-us
/keel-design
```
